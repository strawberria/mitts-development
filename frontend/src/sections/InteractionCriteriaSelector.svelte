<script lang="ts">
    ...
    function copyCriteria() {
        if(selectedCriteriaID !== undefined) {
            const existingCriteriaIndex = $projectStore.storage.states.data[selectedStateID].interactions.data[selectedInteractionID].criteria.ordering.indexOf(selectedCriteriaID);
            ...
            $projectStore.storage.states.data[selectedStateID].interactions.data[selectedInteractionID].criteria.ordering.splice(existingCriteriaIndex + 1, 0, copiedCriteriaID);
            ...
            selectedCriteriaID = copiedCriteriaID;
        }
    }
