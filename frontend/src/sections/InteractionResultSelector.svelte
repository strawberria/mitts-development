<script lang="ts">
    ...
    function copyResult() {
        if(selectedResultID !== undefined) {
            const existingResultIndex = $projectStore.storage.states.data[selectedStateID].interactions.data[selectedInteractionID].results.ordering.indexOf(selectedResultID);
            ...
            $projectStore.storage.states.data[selectedStateID].interactions.data[selectedInteractionID].results.ordering.splice(existingResultIndex + 1, 0, copiedResultID);
            ...
            selectedResultID = copiedResultID;
        }
    }
